...
// import headingStyles from "../styles/headings.css.js"; // Uncomment if you have this
...
export class LoginFormElement extends LitElement {
  ...
  static override styles = [
    resetStyles,
    // headingStyles, // Uncomment if you have this
    css`
      form {
        display: flex;
  ...
  handleSubmit(submitEvent: SubmitEvent) {
    ...
    if (this.canSubmit && this.api) { // Ensure this.api is defined
      fetch(
        this.api,
        {
          method: "POST",
      ...
      .then((res) => {
        ...
        if (!res.ok) { // res.ok checks for statuses in the range 200-299
